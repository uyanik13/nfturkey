<template>
  <div v-show="showModal" class="fixed z-50 inset-0 overflow-y-auto">
    <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
      ...
      <div class="fixed inset-0 transition-opacity" aria-hidden="true">
       ...
       <span class="hidden sm:inline-block sm:align-middle sm:h-screen" aria-hidden="true">&#8203;</span>
          <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 " role="dialog" aria-modal="true" aria-labelledby="modal-headline">
              <div class="bg-gray-100 text-gray-500 rounded-3xl shadow-xl w-full overflow-hidden" style="max-width:1000px">
                <div class="md:flex w-full">
                  ...
                  <!--REGISTER FORM -->
                    <div class="w-full md:w-1/2 py-10 px-5 md:px-10" v-show="showRegisterForm">
                        <a href="#" @click="show = false & $emit('closeLoginRegisterModal',false)" class="absolute right-0  top-0 pr-4 text-8">x</a>
                        <div class="text-center mb-10">
                            <h1 class="font-bold text-3xl text-gray-900">Register</h1>
                            <p>Please fill up all empty inputs for register</p>
                        </div>
                        <div>
                            <div class="flex -mx-3">
                                <div class="w-1/2 px-3 mb-5">
                                    ...
                                    <div class="flex">
                                        ...
                                        <input v-model="form.firstName" type="text" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="John">
                                    </div>
                                </div>
                                <div class="w-1/2 px-3 mb-5">
                                    ...
                                    <div class="flex">
                                        <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i class="mdi mdi-account-outline text-gray-400 text-lg"></i></div>
                                        <input v-model="form.lastName" type="text" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="Smith">
                                    </div>
                                </div>
                            </div>
                            <div class="flex -mx-3">
                            ...
                            <div class="flex -mx-3">
                                ...
                                <div class="w-1/2 px-3 mb-5">
                                    ...
                                    <div class="flex">
                                        <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i class="mdi mdi-lock-outline text-gray-400 text-lg"></i></div>
                                        <input v-model="form.passwordConfirmation" type="password" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="************">
                                    </div>
                                </div>
                            ...
                            <div class="flex">
                                <div class="w-full mb-5 ml-10">
                                    <a href="#" @click="changeFormStatus"  class=" text-4">Do you have an account?</a>
                                </div>
                            </div>
                        </div>
                    </div>
                     ...
                     <!--LOGIN FORM -->
                    <div class="w-full md:w-1/2 py-10 px-5 md:px-10" v-show="showLoginForm">
                        <a href="#" @click="show = false & $emit('closeLoginRegisterModal',false)" class="absolute right-0  top-0 pr-4 text-8">x</a>
                        <div class="text-center mb-10">
                        ...
                        <div>
                            ...
                            <div class="flex -mx-3">
                                <div class="w-full px-3 mb-5">
                                    <button class="block w-full max-w-xs mx-auto bg-secondary hover:bg-indigo-700 focus:bg-indigo-700 text-white rounded-lg px-3 py-3 font-semibold">LOGIN</button>
                                </div>
                            </div>
                            <div class="flex">
                                <div class="w-full mb-5 ml-10">
                                    <a href="#" @click="changeFormStatus"  class=" text-4">Do you want to register?</a>
                                </div>
                                <div class="w-full mb-5 ml-10">
                                    <a href="#" @click="changeFormStatus"  class=" text-4">Did yo forgot your password?</a>
                                </div>
                            </div>
                            <div class="flex -mx-3">
                                <div class="w-full px-3 mb-5">
